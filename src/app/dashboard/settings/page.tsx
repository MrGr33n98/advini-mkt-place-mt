  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-8">
        Gerencie as informações da sua conta, preferências, disponibilidade e segurança.
      </p>
      ...
      <Tabs defaultValue="account" className="space-y-6">
        <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="timeblocking">Bloqueios</TabsTrigger>
        ...
        <TabsContent value="timeblocking" className="space-y-6">
          <TimeBlocking />
        </TabsContent>
